  ...
  return (
    ...
    >
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
        <View style={{ backgroundColor: 'white', padding: 30, borderRadius: 10, width: '80%' }}>
        {isCorrectAnswer ? (
          <Text style={[PracticeStyles.resultText, { color: 'red', justifyContent: 'center', alignItems: 'center', textAlign: 'center', marginBottom: 10 }]}>
            Correct Answer! 
          </Text>
        ) : null}
          <Text style={PracticeStyles.buttonText2}>{trivia}</Text>
          <TouchableOpacity onPress={onClose} style={{ backgroundColor: 'red', padding: 10, borderRadius: 5, borderColor: '#907543', borderWidth: 1, marginTop: 20 }}>
      ...
      {currentQuestionIndex < questionsData.length ? (
        <View style={PracticeStyles.card}>
          ...
          <TextInput
            ...
            placeholderTextColor="#FEFAF6"
          />
          {isWrongAnswer ? (
            <Text style={[PracticeStyles.resultText, { color: 'red', fontWeight: 'bold' }]}>
            Wrong Answer! The correct answer is: {questionsData[currentQuestionIndex].questionAnswer}
          </Text>
